...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { date_concert: @concert.date_concert, duration: @concert.duration, participant: @concert.participant } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { date_concert: @concert.date_concert, duration: @concert.duration, participant: @concert.participant } }
